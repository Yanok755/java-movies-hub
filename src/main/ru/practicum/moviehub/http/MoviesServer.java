...
public class MoviesServer {
    ...
    public MoviesServer(MoviesStore moviesStore, int port) {
        ...
        try {
            ...
            // Регистрируем обработчик для эндпоинта /movies
            this.server.createContext("/movies", new MoviesHandler(moviesStore));

            // Устанавливаем executor (null для использования дефолтного)
    ...
    public void start() {
        ...
        System.out.println("Available endpoint: GET, POST /movies");
    }
