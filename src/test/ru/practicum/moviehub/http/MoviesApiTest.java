...
import ru.practicum.moviehub.testutils.JsonTestUtils;
...
public class MoviesApiTest {
    ...
    void postMovie_whenValidData_returns201Created() throws Exception {
        // Arrange
        String movieJson = JsonTestUtils.createValidMovieJson("Inception", 2010, 148);
    ...
    void getMovies_afterAddingMovie_returnsMovieInArray() throws Exception {
        ...
        String movieJson = JsonTestUtils.createValidMovieJson("The Matrix", 1999, 136);
    ...
    void postMovie_whenInvalidJson_returns400BadRequest() throws Exception {
        // Arrange
        String invalidJson = JsonTestUtils.createInvalidJson();
    ...
    void postMovie_whenMissingRequiredFields_returns400BadRequest() throws Exception {
        // Arrange
        String incompleteJson = JsonTestUtils.createJsonWithMissingFields();
    ...
    void postMovie_whenDuplicateMovie_returns409Conflict() throws Exception {
        ...
        String movieJson = JsonTestUtils.createValidMovieJson("Pulp Fiction", 1994, 154);
    ...
    void postMovie_withoutContentType_returns400BadRequest() throws Exception {
        // Arrange
        String movieJson = JsonTestUtils.createValidMovieJson("Some Movie", 2020, 120);
    ...
    void integrationTest_fullCycle() throws Exception {
        // Arrange
        String[] moviesToAdd = {
            JsonTestUtils.createValidMovieJson("Movie 1", 2001, 100),
            JsonTestUtils.createValidMovieJson("Movie 2", 2002, 110),
            JsonTestUtils.createValidMovieJson("Movie 3", 2003, 120)
        };
        ...
        for (int i = 0; i < moviesToAdd.length; i++) {
            ...
            HttpResponse<String> postResponse = httpClient.send(postRequest, HttpResponse.BodyHandlers.ofString(StandardCharsets.UTF_8));
